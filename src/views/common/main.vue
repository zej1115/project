<template>
    ...
    <div class="w100p h100p pos-relative main-menu-content">
      <div class="h100p pos-abs pos-t0 pos-l0 left-box" :class="isMenuHidden?'left-box-hidden':'left-box-out'">
        <div class="h100p pos-relative menu-box-wrap" >
          <div class="w100p h100p overflow-hidden pos-abs pos-t0 pos-l0 z-2 menu-box">
            <div class="w100p nav-menu nav-menu-normal" v-if="menuStatus">
              <treeMenu :menuList="getMenuData" v-if="!isMenuHidden"></treeMenu>
            </div>
